-- -- Show profile
-- -- photo of user(or avatar)
-- -- join favorites with users or select restaruant_id from favorites (showing favorite resauraunt)
-- create table users (
...
--     id serial primary key,
--     score integer,
--     restaruant_id integer references restaurants(id),
...
-- -- for search of rest access all addresses that match with search
